pipeline {
	...
	stages {
		...
		slackSend baseUrl: 'https://hooks.slack.com/services/', channel: 'devops-slack', color: 'good', message: 'welcome to jenkins', teamDomain: 'HOTSTAR', tokenCredentialId: '8e9fe88a-9e41-49a3-b318-76db094f5cc0'
			}
			}}}	
}}
